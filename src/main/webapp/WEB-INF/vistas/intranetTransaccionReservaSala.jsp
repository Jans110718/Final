					...
					<div class="row">
						...
						<div class="form-group  col-sm-12">
							<label class="control-label" for="id_horaInicio">Hora
								Inicio</label> <input class="form-control" type="time"
								id="id_horaInicio" name="fechaInicio"
								placeholder="Ingrese la hora de inicio Creación" maxlength="100">
						</div>
						<div class="form-group  col-sm-12">
							<label class="control-label" for="id_horaFin">Hora
								Fin</label> <input class="form-control" type="time"
								id="id_horaFin" name="fechaFin"
